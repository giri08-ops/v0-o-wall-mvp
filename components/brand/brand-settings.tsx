          ...
          {[
            {
              ...
              items: ["Brand Name", "Contact Email", "Phone Number"],
            },
            {
              title: "Campaign Settings",
              items: ["Default Point Value", "Campaign Duration", "Notification Preferences"],
            },
            {
              title: "Billing & Payments",
              items: ["Payment Method", "Billing Address", "Invoice History"],
            },
          ].map((section, i) => (
